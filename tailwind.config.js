    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                ...
                'colored-glow': '0 0 20px rgba(59, 130, 246, 0.3)',
                'premium': '0 0 30px rgba(17, 24, 39, 0.1), 0 0 10px rgba(59, 130, 246, 0.1)',
                'hover-lift': '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
            },
            backgroundImage: {
